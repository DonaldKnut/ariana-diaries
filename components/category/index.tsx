      ...
      <div className="container">
        <div className="-mx-4 flex flex-wrap">
          ...
          <div className="w-full px-4 lg:w-4/12 text-[#ffe356]">
              ...
              <div className="flex flex-wrap py-6 px-8">
                {categories.map((catItem) => (
                  <button
                    ...
                    className="mr-3 mb-3 inline-flex items-center justify-center rounded-md bg-[#78680dca] hover:bg-[#78680dca] py-2 px-4 text-white duration-300"
                  >
                    {catItem.label}
                  </button>
                ))}
            ...
            <div className="mb-10 rounded-md bg-[#78680dca] hover:bg-[#78680dca] bg-opacity-5 dark:bg-opacity-10">
              <h3 className="border-b border-body-color border-opacity-10 py-4 px-8 text-lg font-semibold text-[#ffe356] dark:border-white dark:border-opacity-10 dark:text-white">
                Related Blogs
              </h3>
              <ul className="p-8">
